...
class HTMLGenerator
    ...
    def gen_main_index
      ...
      ['Skirmish.gif', 'permalink.gif'].each do |img|
          ipath = File.join(EXTRAS_DIR, img)
          File.copy(ipath, img)
      end
    end
end
...
<div id="menu">
<div id="links">
    <a href="javascript:alert('does not exist')">git</a>
</div>
<h3 class="title">%title%</h3>
</div>
<div id="fullpage">
<div id="logo"><img src="%root%/Skirmish.gif" /></div>
<div id="pager">
<strong>Files:</strong>
START:allfiles
...
<BODY>
Click <a href="%initial_page%">here</a> to open the Skirmish docs.
</BODY>
</HTML>
}
